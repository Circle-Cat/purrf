...
class TestCountMessagesInDateRange(unittest.TestCase):
    ...
    @patch("backend.common.redis_client.RedisClientFactory.create_redis_client")
    @patch("backend.frontend_service.chat_query_utils.get_chat_spaces")
    @patch("backend.frontend_service.chat_query_utils.get_all_ldaps_and_displaynames")
    ...
    @patch("backend.common.redis_client.RedisClientFactory.create_redis_client")
    @patch(
        "backend.frontend_service.chat_query_utils.get_chat_spaces",
