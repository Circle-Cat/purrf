...
class TestMicrosoftGraphServiceClient(unittest.TestCase):
    @patch("backend.common.microsoft_graph_service_client.GraphServiceClient")
    @patch("backend.common.microsoft_graph_service_client.DefaultAzureCredential")
    @patch(
        "backend.common.microsoft_graph_service_client.MICROSOFT_SCOPES_LIST",
