...
class TestChatUtils(TestCase):
    @patch(
        "backend.consumers.google_chat_consumer.GoogleClientFactory.create_people_client"
    )
...
class TestPullMessages(TestCase):
    ...
    @patch("backend.consumers.google_chat_consumer.PubSubPuller")
    ...
    @patch("backend.consumers.google_chat_consumer.PubSubPuller")
    @patch("backend.consumers.google_chat_consumer.renew_subscription")
    ...
    @patch("backend.consumers.google_chat_consumer.GoogleClientFactory")
    ...
    @patch("backend.consumers.google_chat_consumer.store_messages")
    @patch("backend.consumers.google_chat_consumer.get_ldap_by_id")
    @patch("backend.consumers.google_chat_consumer.PubSubPuller")
