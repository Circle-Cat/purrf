...
class TestAppRoutes(TestCase):
    ...
    @patch("backend.consumers.consumer_api.check_pulling_status")
    ...
    @patch("backend.consumers.consumer_api.stop_pulling_process")
    ...
    @patch("backend.consumers.consumer_api.pull_microsoft_message")
    ...
    @patch("backend.consumers.consumer_api.pull_messages")
