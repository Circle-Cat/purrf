...
from backend.common.constants import MicrosoftChatMessagesChangeType
from unittest.mock import patch, MagicMock, AsyncMock
from backend.consumers.microsoft_chat_consumer import (
    process_data_async,
...
class TestMicrosoftChatConsumer(IsolatedAsyncioTestCase):
    ...
    @patch(
        "backend.consumers.microsoft_chat_consumer.sync_near_real_time_message_to_redis",
    ...
    @patch("backend.consumers.microsoft_chat_consumer.logger")
    ...
    @patch("backend.consumers.microsoft_chat_consumer.PubSubPuller")
