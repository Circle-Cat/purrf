...
from backend.utils.google_chat_message_store import store_messages, StoredMessage
...
class TestStoreMessages(TestCase):
    def setUp(self):
        ...
        self.patcher = patch(
            "backend.utils.google_chat_message_store.RedisClientFactory.create_redis_client"
        )
