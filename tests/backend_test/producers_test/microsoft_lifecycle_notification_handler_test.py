...
from backend.producers.microsoft_lifecycle_notification_handler.main import (
...
class TestMicrosoftLifecycleNotificationHandler(IsolatedAsyncioTestCase):
    @patch("backend.producers.microsoft_lifecycle_notification_handler.main.Redis")
    ...
    @patch(
        "backend.producers.microsoft_lifecycle_notification_handler.main._renew_and_reauthorize_subscription",
    ...
    @patch(
        "backend.producers.microsoft_lifecycle_notification_handler.main._validate_identity",
        return_value=True,
    )
    @patch(
        "backend.producers.microsoft_lifecycle_notification_handler.main._process_lifecycle_event",
        new_callable=AsyncMock,
    )
    ...
    @patch(
        "backend.producers.microsoft_lifecycle_notification_handler.main._handle_lifecycle_notification_webhook",
        new_callable=AsyncMock,
    )
