...
class TestSubscribeChatMessages(IsolatedAsyncioTestCase):
    ...
    @patch("backend.notification_management.microsoft_chat_watcher._generate_client_state")
    @patch("backend.notification_management.microsoft_chat_watcher._update_client_state")
    @patch("backend.notification_management.microsoft_chat_watcher.datetime")
    @patch("backend.notification_management.microsoft_chat_watcher.MicrosoftClientFactory")
    ...
    @patch("backend.notification_management.microsoft_chat_watcher.RedisClientFactory")
