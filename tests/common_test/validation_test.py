...
class TestValidateData(TestCase):
    @patch("src.common.validation.open", new_callable=mock_open)
    @patch("src.common.validation.json.load")
    ...
    @patch("src.common.validation.open", side_effect=FileNotFoundError)
