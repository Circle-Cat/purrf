...
class TestGoogleClientFactory(TestCase):
    ...
    def test_client_creation_flow(self):
        for function_name, api_name, api_version, cache_attr in CLIENT_CONFIGS:
            ...
            with (
                ...
                patch(
                    "src.common.google_client.ImpersonatedCredentials"
                ) as mock_impersonated_creds,
                patch("src.common.google_client.build") as mock_build,
                patch.dict(
                    os.environ,
                    {
    ...
    @patch("src.common.google_client.SubscriberClient")
    ...
    @patch("src.common.google_client.PublisherClient")
