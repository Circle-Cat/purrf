...
class TestMicrosoftChatHistoryFetcher(IsolatedAsyncioTestCase):
    ...
    @patch(
        "src.historical_data.microsoft_chat_history_fetcher.get_all_microsoft_members",
    ...
    @patch("src.historical_data.microsoft_chat_history_fetcher.MicrosoftClientFactory")
    ...
    @patch(
        "src.historical_data.microsoft_chat_history_fetcher.sync_history_chat_messages_to_redis"
    )
    @patch(
        "src.historical_data.microsoft_chat_history_fetcher.get_microsoft_chat_messages_by_chat_id"
    )
    @patch(
        "src.historical_data.microsoft_chat_history_fetcher.list_all_id_ldap_mapping",
        new_callable=AsyncMock,
    )
