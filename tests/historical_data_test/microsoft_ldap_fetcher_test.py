...
from src.historical_data.microsoft_ldap_fetcher import (
...
class TestMicrosoftLdapFetcher(IsolatedAsyncioTestCase):
    @patch(
        "src.common.microsoft_client.MicrosoftClientFactory.create_graph_service_client"
    )
    ...
    @patch("src.historical_data.microsoft_ldap_fetcher.get_all_microsoft_members")
    ...
    @patch("src.common.redis_client.RedisClientFactory.create_redis_client")
    @patch(
        "src.historical_data.microsoft_ldap_fetcher.get_all_microsoft_members",
