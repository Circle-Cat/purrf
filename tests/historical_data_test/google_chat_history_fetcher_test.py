...
class TestChatUtils(TestCase):
    ...
    @patch(
        "src.historical_data.google_chat_history_fetcher.GoogleClientFactory.create_chat_client"
    )
    ...
    @patch("src.historical_data.google_chat_history_fetcher.store_messages")
    @patch(
        "src.historical_data.google_chat_history_fetcher.list_directory_all_people_ldap"
    )
    @patch(
        "src.historical_data.google_chat_history_fetcher.fetch_messages_by_spaces_id"
    )
    @patch("src.historical_data.google_chat_history_fetcher.get_chat_spaces")
