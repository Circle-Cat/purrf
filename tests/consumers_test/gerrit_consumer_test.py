...
from src.consumers.gerrit_consumer import (
    store_payload,
    pull_gerrit,
)
from src.consumers.pubsub_puller import PullStatusResponse
...
class TestStorePayload(unittest.TestCase):
    @patch("src.consumers.gerrit_consumer.store_change")
    @patch("src.consumers.gerrit_consumer.RedisClientFactory")
    ...
    @patch("src.consumers.gerrit_consumer.compute_buckets")
    @patch("src.consumers.gerrit_consumer.RedisClientFactory")
...
class TestPullGerrit(unittest.TestCase):
    ...
    @patch("src.consumers.gerrit_consumer.PubSubPuller")
