...
from src.utils.microsoft_chat_message_store import (
    _get_ldap_by_id,
...
class TestMicrosoftChatMessageStore(IsolatedAsyncioTestCase):
    ...
    @patch("src.utils.microsoft_chat_message_store.MicrosoftClientFactory")
    @patch("src.utils.microsoft_chat_message_store.RedisClientFactory")
    @patch("src.utils.microsoft_chat_message_store._get_ldap_by_id")
    @patch("src.utils.microsoft_chat_message_store._handle_created_messages")
    @patch("src.utils.microsoft_chat_message_store._handle_deleted_message")
    @patch("src.utils.microsoft_chat_message_store._handle_update_message")
