...
from src.frontend_service import gerrit_loader
...
class TestGerritLoader(unittest.TestCase):
    ...
    @patch("src.frontend_service.gerrit_loader.RedisClientFactory")
    @patch("src.frontend_service.gerrit_loader.get_all_active_ldap_users")
