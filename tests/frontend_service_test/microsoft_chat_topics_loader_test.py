...
from src.frontend_service.microsoft_chat_topics_loader import (
    get_microsoft_chat_topics,
    cache_chat_topics,
)
from src.common.environment_constants import MICROSOFT_ADMIN_LDAP, MICROSOFT_USER_LDAP
...
class TestMicrosoftChatTopicsLoader(IsolatedAsyncioTestCase):
    ...
    @patch(
        "src.frontend_service.microsoft_chat_topics_loader.RedisClientFactory.create_redis_client"
    )
    @patch(
        "src.frontend_service.microsoft_chat_topics_loader.cache_chat_topics",
    ...
    @patch(
        "src.frontend_service.microsoft_chat_topics_loader.MicrosoftClientFactory.create_graph_service_client"
    )
    @patch(
        "src.frontend_service.microsoft_chat_topics_loader.list_all_id_ldap_mapping",
        new_callable=AsyncMock,
    )
    ...
    @patch("src.frontend_service.microsoft_chat_topics_loader.MicrosoftClientFactory")
    @patch(
        "src.frontend_service.microsoft_chat_topics_loader.list_all_id_ldap_mapping",
        new_callable=AsyncMock,
    )
