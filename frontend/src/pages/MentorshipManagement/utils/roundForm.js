...
export function getSeasonDefaults(season, year) {
  ...
  if (season === "Spring") {
    return {
      ...
      onboardingNotificationAt: new Date(y, 1, 2),
      onboardingDeadlineAt: new Date(y, 1, 9),
      matchNotificationAt: new Date(y, 1, 12),
      firstMeetingDeadlineAt: new Date(y, 1, 26),
  ...
  if (season === "Summer") {
    return {
      ...
      onboardingNotificationAt: new Date(y, 4, 2),
      onboardingDeadlineAt: new Date(y, 4, 9),
      matchNotificationAt: new Date(y, 4, 12),
      firstMeetingDeadlineAt: new Date(y, 4, 26),
  ...
  if (season === "Fall") {
    return {
      ...
      onboardingNotificationAt: new Date(y, 8, 2),
      onboardingDeadlineAt: new Date(y, 8, 9),
      matchNotificationAt: new Date(y, 8, 12),
      firstMeetingDeadlineAt: new Date(y, 8, 26),
