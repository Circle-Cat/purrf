 ...
 * AccountStateChips
 *
 * Copied verbatim from the accounts console (`AdminAccounts/components/
 * StateChips.jsx`) so the mentorship tables say the same thing the same way;
 * the real page imports that component rather than keeping a copy. The
 * prototype branch predates it, hence the copy.
 *
 ...
 * @returns {JSX.Element}
 */
const AccountStateChips = ({ isActive, isBlocked, hasPendingBlockRequest }) => {
  const base =
...
export default AccountStateChips;
