...
from backend.dto.leave_ledger_dto import LeaveBalanceDto, LeaveLedgerEntryDto
    ...
    async def get_leave_balance(
        ...
        entry_dtos = [
            LeaveLedgerEntryDto(
                ...
                hours=f"{entry.hours:.2f}",  # 保证精准度，转为 2 位小数的字符串
                note=entry.note,
            )
